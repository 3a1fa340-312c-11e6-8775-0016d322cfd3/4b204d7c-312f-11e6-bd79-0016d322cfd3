...
{																\
	...
	{															\
		...
		if (NdisEqualMemory(_IPX, _pBufVA + 12, 2) || 			\
...
{																\
	...
	{															\
		_pExtraLlcSnapEncap = SNAP_802_1H;						\
		if (NdisEqualMemory(_IPX, _pBufVA, 2) || 				\
...
{                                                                       \
    ...
    {                                                                   \
        PUCHAR pProto = _pData + 6;                                     \
                                                                        \
        if ((NdisEqualMemory(_IPX, pProto, 2) || NdisEqualMemory(APPLE_TALK, pProto, 2)) &&  \
...
/*	RTMP_OS_TASK			cmdQTask; */
    ...
    RTMP_OS_SEM UsbKickOutCmd_semaphore;
