...
#define TIMERQ_TASK_PRI         	    20
#define TIMERQ_TASK_STACK_SIZE  	    4096
static	uint8			TimerQ_Stack[TIMERQ_TASK_STACK_SIZE];

//MLME Thread initiation information
#define MLME_TASK_PRI         	        20
#define MLME_TASK_STACK_SIZE  	        4096
static	uint8			MLME_Stack[MLME_TASK_STACK_SIZE];

//CmdQ Thread initiation information
#define CMDQ_TASK_PRI         	        20
#define CMDQ_TASK_STACK_SIZE  	        4096
static	uint8			CmdQ_Stack[CMDQ_TASK_STACK_SIZE];

//RTUSBBulkRx Thread initiation information
#define RTUSBBulkRx_TASK_PRI         	20
#define RTUSBBulkRx_TASK_STACK_SIZE  	8192
static	uint8			RTUSBBulkRx_Stack[RTUSBBulkRx_TASK_STACK_SIZE];
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	*/
    ...
    #ifndef _LINUX_SOURCE_
    pTask->sched_info = (cyg_addrword_t)TIMERQ_TASK_PRI;
    pTask->stack_base = (void *)TimerQ_Stack;
    pTask->stack_size = TIMERQ_TASK_STACK_SIZE;
    #endif /* _LINUX_SOURCE_ */
    ...
    #ifndef _LINUX_SOURCE_
    pTask->sched_info = (cyg_addrword_t)MLME_TASK_PRI;
    pTask->stack_base = (void *)MLME_Stack;
    pTask->stack_size = MLME_TASK_STACK_SIZE;
    #endif /* _LINUX_SOURCE_ */
    ...
    #ifndef _LINUX_SOURCE_
    pTask->sched_info = (cyg_addrword_t)CMDQ_TASK_PRI;
    pTask->stack_base = (void *)CmdQ_Stack;
    pTask->stack_size = CMDQ_TASK_STACK_SIZE;
    #endif /* _LINUX_SOURCE_ */
