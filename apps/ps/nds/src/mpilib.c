...
//12/23/99 marked	static BYTE WaitState; //Simon 12/13/99
//12/23/99 marked	static BYTE WaitCount; //Simon 12/13/99
	...
	while (bits--)
	{
		...
		//Simon 12/13/99 added //////
//12/23/99		if(++WaitState >= 0x02) {
		kwait(NULL);
//12/23/99			WaitState = 0;
//12/23/99			WaitCount++;
//12/23/99		}
		/////////////////////////////
	}	/* while bits-- */
