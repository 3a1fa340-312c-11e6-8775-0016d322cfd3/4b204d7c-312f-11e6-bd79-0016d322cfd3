...
#define CMD20	  0x20	 // Send EEPROM data to the computer of PSQC2.
#define CMD21     0x21   // Config Box
#define CMD24     0x24   // View Box
#define CMD25     0x25   // Pre-share key security setting
#define CMD2A     0x2A   // Start USB ETHERNET test (IPX only)
#define CMD2B     0x2B   // Request USB ETHERNET test data (IPX only)
#define CMD2C     0x2C   // End USB ETHERNET test (IPX only)
