...
#define RELEASE_RESOURCE_TIMEOUT     60 // seconds 3/8/2002 by ron for process.c use
#define SET_SMBD_TIMEOUT   60*3        // Replace DEFAULT_SMBD_TIMEOUT to 10 mins Idle will disconnect the connection_struct *conn 3/8/2002
