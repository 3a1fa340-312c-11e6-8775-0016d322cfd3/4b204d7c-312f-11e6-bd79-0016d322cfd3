...
struct oid_obj_priv oid_rtl_seg_87_12_00[]=
{
	...
	{1, &oid_rt_pro_read_efuse_hdl},		//0X05	Q
	{1, &oid_rt_pro_write_efuse_hdl},		//0X06	S
...
struct mp_ioctl_handler mp_ioctl_hdl[] = {
	...
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_pro_start_test_hdl, OID_RT_PRO_START_TEST)/*0*/
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_pro_stop_test_hdl, OID_RT_PRO_STOP_TEST)/*1*/
	...
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_pro_set_channel_direct_call_hdl, OID_RT_PRO_SET_CHANNEL_DIRECT_CALL)
	GEN_MP_IOCTL_HANDLER(sizeof(struct txpower_param), oid_rt_pro_set_tx_power_control_hdl, OID_RT_PRO_SET_TX_POWER_CONTROL)
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_pro_set_data_rate_hdl, OID_RT_PRO_SET_DATA_RATE)
	...
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), NULL, 0)/*17*/
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_pro_set_continuous_tx_hdl, OID_RT_PRO_SET_CONTINUOUS_TX)/*18*/ 
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_set_bandwidth_hdl, OID_RT_SET_BANDWIDTH)/*19*/
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_set_rx_packet_type_hdl, OID_RT_SET_RX_PACKET_TYPE)/*20*/
	GEN_MP_IOCTL_HANDLER(0, oid_rt_reset_phy_rx_packet_count_hdl, OID_RT_RESET_PHY_RX_PACKET_COUNT)/*21*/
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_get_phy_rx_packet_received_hdl, OID_RT_GET_PHY_RX_PACKET_RECEIVED)/*22*/
	GEN_MP_IOCTL_HANDLER(sizeof(unsigned int), oid_rt_get_phy_rx_packet_crc32_error_hdl, OID_RT_GET_PHY_RX_PACKET_CRC32_ERROR)/*23*/
