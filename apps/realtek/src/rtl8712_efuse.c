...
//------------------------------------------------------------------------------
 int efuse_one_byte_read(_adapter * padapter, u16 addr,u8 *data);
 int efuse_one_byte_write(_adapter * padapter,  u16 addr, u8 data);	
#endif //0
//------------------------------------------------------------------------------

 u8 efuse_one_byte_rw(_adapter *padapter, u8 bRead, u16 addr, u8 *data);
...
//------------------------------------------------------------------------------
u8 efuse_one_byte_write(_adapter *padapter, u16 addr, u8 data)
{
	u8 tmpidx = 0, bResult;
