...
_func_enter_;		
	...
	memset(pcmdpriv->cmd_allocated_buf, 0, MAX_CMDSZ + CMDBUFF_ALIGN_SZ);	//eason 20100407	
	...
	memset(pcmdpriv->rsp_allocated_buf, 0, MAX_RSPSZ +4);	//eason 20100407	
...
_func_enter_;		
	...
	memset(pevtpriv->evt_allocated_buf, 0, MAX_EVTSZ +4);	//eason 20100407	
	...
	memset(pevtpriv->allocated_c2h_mem, 0, C2H_MEM_SZ +4);	//eason 20100407
...
_func_enter_;	
	...
	memset(ph2c, 0, sizeof(struct cmd_obj));	//eason 20100407
	...
	memset(psetusbsuspend, 0, sizeof(struct usb_suspend_parm));	//eason 20100407
...
_func_enter_;	
	...
	memset(psurveyPara, 0, sizeof(struct sitesurvey_parm));	//eason 20100407
...
//eason 20100520	padapter->ledpriv.LedControlHandler(padapter, LED_CTL_SITE_SURVEY);
...
_func_enter_;	
	...
	memset(pbsetdataratepara, 0, sizeof(struct setdatarate_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(pssetbasicratepara, 0, sizeof(struct setbasicrate_parm));	//eason 20100407
...
_func_enter_;	
	...
	memset(psetphypara, 0, sizeof(struct setphy_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(pwriteptmparm, 0, sizeof(struct writePTM_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(pwriteptmparm, 0, sizeof(struct setdig_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(ph2c, 0, sizeof(struct setra_parm));	//eason 20100407	
	...
	memset(pwriteptmparm, 0, sizeof(struct setra_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(pwritebbparm, 0, sizeof(struct writeBB_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(prdbbparm, 0, sizeof(struct readBB_parm));	//eason 20100407	
...
_func_enter_;
	...
	memset(pwriterfparm, 0, sizeof(struct writeRF_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(prdrfparm, 0, sizeof(struct readRF_parm));	//eason 20100407
	_init_listhead(&ph2c->list);
...
//eason 20100520	padapter->ledpriv.LedControlHandler(padapter, LED_CTL_START_TO_LINK);
...
//eason 20100520	padapter->ledpriv.LedControlHandler(padapter, LED_CTL_START_TO_LINK);
	...
	//eason 20101001
	if(ndis_network_mode == Ndis802_11IBSS)   
		pregistrypriv->channel = psecnetwork->Configuration.DSConfig;
...
_func_enter_;
	...
	RT_TRACE(_module_rtl871x_cmd_c_,_drv_info_,("disassoc_cmd. \n"));
	...
	//if ((check_fwstate(pmlmepriv, _FW_LINKED)) == _TRUE) {
		...
		memset(pdisconnect_cmd, 0, sizeof(struct	cmd_obj));	//eason 20100407	
		...
		memset(pdisconnect, 0, sizeof(struct	disconnect_parm));	//eason 20100407	
...
_func_enter_;
	...
	memset(psetop, 0, sizeof(struct setopmode_parm));	//eason 20100407
...
_func_enter_;
	...
	memset(psetstakey_para, 0, sizeof(struct set_stakey_parm));	//eason 20100407
	...
	memset(psetstakey_rsp, 0, sizeof(struct set_stakey_rsp));	//eason 20100407
...
_func_enter_;	
	...
	memset(psetrfintfsparm, 0, sizeof(struct setrfintfs_parm));	//eason 20100407
...
_func_enter_;	
	...
	memset(psetrttblparm, 0, sizeof(struct setratable_parm));	//eason 20100407
...
_func_enter_;	
	...
	memset(pgetrttblparm, 0, sizeof(struct getratable_parm));	//eason 20100407	
//	init_h2fwcmd_w_parm_no_rsp(ph2c, psetrttblparm, GEN_CMD_CODE(_SetRaTable));
...
_func_enter_;
	...
	memset(prdtssiparm, 0, sizeof(struct readTSSI_parm));	//eason 20100407	
	_init_listhead(&ph2c->list);
...
_func_enter_;	
	...
	memset(psetassocsta_para, 0, sizeof(struct set_assocsta_parm));	//eason 20100407
	...
	memset(psetassocsta_rsp, 0, sizeof(struct set_assocsta_rsp));	//eason 20100407
...
_func_enter_;	
	...
	memset(paddbareq_parm, 0, sizeof(struct addBaReq_parm));	//eason 20100407
...
_func_enter_;	
	...
	if((pcmd->res != H2C_SUCCESS))
	{				
		RT_TRACE(_module_rtl871x_cmd_c_,_drv_err_,("\n ********Error:select_and_join_from_scanned_queue Wait Sema  Fail ************\n\n."));
...
_func_enter_;
	...
	memset(psetatim, 0, sizeof(struct setatim_parm));	//eason 20100407
	//NdisZeroMemory();
	psetatim->op = add;
	psetatim->txid = txid;
