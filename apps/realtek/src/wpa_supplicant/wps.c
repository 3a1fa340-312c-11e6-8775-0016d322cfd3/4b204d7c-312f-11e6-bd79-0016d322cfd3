...
struct wps_data *WPS_DATA_GLOBE = 0;	//ZOT 20100712
...
struct wps_data * wps_init(const struct wps_config *cfg)
{
	...
	memset(data, 0, sizeof(*data));	//eason 20100407	
	data->wps = cfg->wps;
	...
	if (cfg->pin) {
		...
		os_memset(data->dev_password, 0, cfg->pin_len); 	//eason 20100407	
	...
	WPS_DATA_GLOBE = data;	//ZOT 20100712
