				    ...
				    size_t str_len)
{
	...
	if (dev->manufacturer == NULL)
		return -1;
	memset(dev->manufacturer, 0, str_len + 1);	//eason 20100407		
				  ...
				  size_t str_len)
{
	...
	if (dev->model_name == NULL)
		return -1;
	memset(dev->model_name, 0, str_len + 1);	//eason 20100407	
				    ...
				    size_t str_len)
{
	...
	if (dev->model_number == NULL)
		return -1;
	memset(dev->model_number, 0, str_len + 1);	//eason 20100407	
				     ...
				     const u8 *str, size_t str_len)
{
	...
	if (dev->serial_number == NULL)
		return -1;
	memset(dev->serial_number, 0, str_len + 1);	//eason 20100407		
				...
				size_t str_len)
{
	...
	if (dev->device_name == NULL)
		return -1;
	memset(dev->device_name, 0, str_len + 1);	//eason 20100407	
