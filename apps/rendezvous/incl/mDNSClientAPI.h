...
// Ron #define MaximumRDSize 8192
#define MaximumRDSize 1024 //Ron
...
//Ron #define InlineCacheRDSize 64
#define InlineCacheRDSize 32 //Ron
...
typedef struct
	...
	mDNSu16         TXTlen;
//Ron 	mDNSu8          TXTinfo[2048];		// Additional demultiplexing information (e.g. LPR queue name)
	mDNSu8          TXTinfo[1024];		// Additional demultiplexing information (e.g. LPR queue name)
	} ServiceInfo;
...
//Ron #define AbsoluteMaxDNSMessageData 8940
#define AbsoluteMaxDNSMessageData 1532
...
// ***************************************************************************
#define MAX_mDNSservice_name 64
#define MAX_mDNSservice_serviceType 64
#define MAX_mDNSservice_domain 64
#define MAX_mDNSservice_TXT 300

typedef packedstruct mDNSservicesList_struct mDNSservicesList  ;
typedef packedstruct mDNSservice_TXT_struct  mDNSservice_TXT;

packedstruct mDNSservicesList_struct {
	mDNSservicesList  *next;
	mDNSu8  mDNSservice_servicesName[MAX_mDNSservice_name];
	mDNSu8  mDNSservice_serviceType[MAX_mDNSservice_serviceType];
	mDNSu8  mDNSservice_domain[MAX_mDNSservice_domain];
	mDNSu32 service_port;
	unsigned int  mDNSservice_TXT_len;
	mDNSu8  mDNSservice_TXT[MAX_mDNSservice_TXT];
};
