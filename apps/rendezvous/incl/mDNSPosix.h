...
//Ron extern void mDNSPosixGetFDSet(mDNS *const m, int *nfds, fd_set *readfds, struct timeval *timeout);
//Ron extern void mDNSPosixProcessFDSet(mDNS *const m, fd_set *readfds);
