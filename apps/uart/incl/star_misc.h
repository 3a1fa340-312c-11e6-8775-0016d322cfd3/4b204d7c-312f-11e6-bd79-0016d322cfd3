...
#define SYSPA_MISC_BASE_ADDR	0x76000000	//ZOT

//ZOT #if defined(__UBOOT__)
#define	MISC_MEM_MAP_VALUE(reg_offset)		(*((unsigned int volatile *)(SYSPA_MISC_BASE_ADDR + reg_offset)))
//ZOT #elif defined(__LINUX__)
//ZOT #define	MISC_MEM_MAP_VALUE(reg_offset)		(*((u32 volatile *)(SYSVA_MISC_BASE_ADDR + reg_offset)))
//ZOT #else
