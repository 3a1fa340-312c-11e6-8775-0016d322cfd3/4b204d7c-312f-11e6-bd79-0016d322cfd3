...
//ZOT #include <common.h>
//ZOT #include <asm/arch/star_uart.h>
#include "star_uart.h"	//ZOT
//ZOT #include <asm/arch/star_powermgt.h>
#include <star_powermgt.h>	//ZOT
//ZOT #include <asm/arch/star_misc.h>
#include <star_misc.h>	//ZOT
//#include <asm/arch/star_system.h>

#define u32	unsigned int
#define CONFIG_CONSOLE_UART_PORT	0
...
{
//zot	DECLARE_GLOBAL_DATA_PTR;

	star_serial_hw_init();
//ZOT	star_serial_config_baud_rate(0, gd->baudrate, UART_INPUT_CLOCK);
	star_serial_config_baud_rate(0, CONFIG_BAUDRATE, UART_INPUT_CLOCK);	//ZOT
	star_serial_config_line_control(0, WORD_EIGHT_BITS, NONE_PARITY, ONE_STOP_BIT);
	star_serial_config_fifo(0, TX_RX_FIFO_ENABLE, 8);

//ZOT	star_serial_config_baud_rate(1, gd->baudrate, UART_INPUT_CLOCK);
	star_serial_config_baud_rate(1, CONFIG_BAUDRATE, UART_INPUT_CLOCK);	//ZOT
