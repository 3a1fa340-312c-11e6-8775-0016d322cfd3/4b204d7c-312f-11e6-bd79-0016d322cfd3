...
//os	struct timer rh_int_timer;		//timer_list change to timer
};
...
//615wu only supported 712 printer
...
static void td_fill(ohci_t * ohci, unsigned int info, char * data, int len, struct urb * urb, int index);
