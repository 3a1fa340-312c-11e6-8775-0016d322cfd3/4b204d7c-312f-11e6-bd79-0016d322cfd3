...
#define __exit
#define __init
//ZOT716u2 typedef unsigned char        u8;
//ZOT716u2 typedef unsigned short       u16;
//ZOT716u2 typedef unsigned int         u32;
...
#define writel(val,addr) outl2((val),(uint32)(addr))
#define readl(addr) inl2((uint32)(addr))
#define writew(val,addr) outw2((val),(uint32)(addr))
#define readw(addr) inw2((uint32)(addr))
/*-------------------------------------------------------------------------*/
...
//os	struct timer	rh_timer;	//635u2
