    ...
    OUT PEAPOL_PACKET       pMsg)
{
    ...
    {
        KEY_INFO tmpKeyInfo;
        NdisMoveMemory((PUCHAR)(&tmpKeyInfo), (PUCHAR)(&pMsg->KeyDesc.KeyInfo), sizeof(KEY_INFO));
	    *(USHORT *)(&tmpKeyInfo) = cpu2le16(*(USHORT *)(&tmpKeyInfo));
        NdisMoveMemory((PUCHAR)(&pMsg->KeyDesc.KeyInfo), (PUCHAR)(&tmpKeyInfo), sizeof(KEY_INFO));
    }
#else
