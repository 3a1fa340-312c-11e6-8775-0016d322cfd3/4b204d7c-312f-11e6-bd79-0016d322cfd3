...
#define SYSPA_VIC_BASE_ADDR	0xFFFFF000	//ZOT

//ZOT #if defined(__UBOOT__)
#define	INTC_MEM_MAP_VALUE(reg_offset)		(*((unsigned int volatile *)(SYSPA_VIC_BASE_ADDR + reg_offset)))
//ZOT #elif defined(__LINUX__)
//ZOT #define	INTC_MEM_MAP_VALUE(reg_offset)		(*((u32 volatile *)(SYSVA_VIC_BASE_ADDR + reg_offset)))
//ZOT #else
