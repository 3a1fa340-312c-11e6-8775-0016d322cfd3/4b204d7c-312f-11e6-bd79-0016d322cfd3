...
#define SYSPA_POWER_MANAGEMENT_BASE_ADDR 0x77000000	//ZOT

//ZOT #if defined(__UBOOT__)
#define	PWRMGT_MEM_MAP_VALUE(reg_offset)	(*((unsigned int volatile *)(SYSPA_POWER_MANAGEMENT_BASE_ADDR + reg_offset)))
//ZOT #elif defined(__LINUX__)
//ZOT #define	PWRMGT_MEM_MAP_VALUE(reg_offset)	(*((u32 volatile *)(SYSVA_POWER_MANAGEMENT_BASE_ADDR + reg_offset)))
//ZOT #else
