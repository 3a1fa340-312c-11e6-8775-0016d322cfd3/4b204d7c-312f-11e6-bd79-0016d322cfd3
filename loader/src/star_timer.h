...
#define SYSPA_TIMER_BASE_ADDR	0x79000000	//ZOT

//ZOT #if defined(__UBOOT__)
#define	TIMER_MEM_MAP_VALUE(reg_offset)		(*((unsigned int volatile *)(SYSPA_TIMER_BASE_ADDR + reg_offset)))
//ZOT #elif defined(__LINUX__)
//ZOT #define	TIMER_MEM_MAP_VALUE(reg_offset)		(*((u32 volatile *)(SYSVA_TIMER_BASE_ADDR + reg_offset)))
//ZOT #else
