...
CC   = $(GCC_DIR)/arm-elf-gcc -mcpu=arm9
...
CFLAGS    = -Wall $(INC_DIR) -ffunction-sections -fdata-sections -fshort-enums
...
LDFLAGS   = -nostartfiles -L$(PKG_INSTALL_DIR)/lib -Wl,--gc-sections\
    -Ttarget.ld -nostdlib  -Xlinker -Map -Xlinker $(basename $@).map
ARFLAGS   = rv
COPTFLAGS     = -O3
#COPTFLAGS     = -g
