...
#include "pstarget.h"	//ZOT
#include "psglobal.h"	//ZOT
#include "psdefine.h"	//ZOT
#include "star_enic.h"	//ZOT
#include "star_powermgt.h"	//ZOT
#include "star_intc.h"	//ZOT
...
//ZOT==> typedef uint32	spinlock_t;	//ZOT
...
//ZOT	struct net_device_stats stats;
	spinlock_t lock;
	int dev_index;
	u8 phy_addr;
	u16 phy_id;
