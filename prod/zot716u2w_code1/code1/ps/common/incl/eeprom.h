...
#define NCBNAMSZ				16
#define RANDID_SIGNATURE	    0x0FF  // RANDOM NIDE ID MARK ... Ron 4/3/2003
...
// Others		1
	...
	BYTE WLTxMode;                //0:B/G Mixed 1:B Only 2:G Only 3:B/G/N Mixed	PS: apmode or WLTxMode
...
// Total		1324 = 1300 + 24
// Wireless		24 = 2 + 2 + 2 + 1 + 1 + 1 + 1 + 2 + 2 + 2 + 1 + 1 + 1 + 1 + 4
	...
	BYTE WLAuthenticationType;	// 0x01: Open system		0x02: Share Key
...
// Enhance Part
	...
	// Enhance Part Total	3500 = 3496 + 4
	// Checksum				4
