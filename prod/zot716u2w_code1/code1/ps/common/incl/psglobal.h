...
#define huge
#define down( s )			{ while( *s == 1 ) cyg_thread_yield(); *s = 1; }	//615wu
#define up( s )				*s = 0	//615wu
#define spin_lock_init( s )	*s = 0	//615wu
...
#define _WLAuthenticationType	(EEPROM_Data.WLAuthenticationType)
