...
//ZOT#include <asm/arch/star_sys_memory_map.h>
#define	SYSPA_GPIOA_BASE_ADDR			0x7C000000	//ZOT
#define	SYSPA_GPIOB_BASE_ADDR			0x7C800000	//ZOT

//ZOT#if defined(__UBOOT__)
...
//ZOT#elif defined(__LINUX__)
//ZOT#define	GPIOA_MEM_MAP_VALUE(reg_offset)		(*((u32	volatile *)(SYSVA_GPIOA_BASE_ADDR + reg_offset)))
//ZOT#define	GPIOB_MEM_MAP_VALUE(reg_offset)		(*((u32	volatile *)(SYSVA_GPIOB_BASE_ADDR + reg_offset)))
//ZOT#else
//ZOT#error "NO SYSTEM DEFINED"
//ZOT#endif
