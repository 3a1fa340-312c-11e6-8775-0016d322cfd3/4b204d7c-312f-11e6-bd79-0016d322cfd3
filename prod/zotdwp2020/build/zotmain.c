...
#define	SYSPA_SDRAM__CTRL_BASE_ADDR			0x72000000	//ZOT
#define	SDRAM_MEM_MAP_VALUE(reg_offset)		(*((unsigned int	volatile *)(SYSPA_SDRAM__CTRL_BASE_ADDR + reg_offset)))
#define	SDRAM_DRAM_CFG_REG			SDRAM_MEM_MAP_VALUE(0x04)
#define	SDRAM_DQS_DLY_REG			SDRAM_MEM_MAP_VALUE(0x30)
