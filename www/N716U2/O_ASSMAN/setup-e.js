...
//Language : English
tabArray=['Print Server','Status','Setup','Misc','Restart','System','TCP/IP','NetWare','AppleTalk','SNMP','SMB','',''];
...
textArray7[iIndex++]="This IP Address is incorrect. Please try again.";
textArray7[iIndex++]="This subnet mask is incorrect. Please try again.";
textArray7[iIndex++]="This gateway is incorrect. Please try again.";
textArray7[iIndex++]="This polling time is incorrect. Please try again.";
textArray7[iIndex++]="This print server name is incorrect. Please try again.";
textArray7[iIndex++]="This file server name is incorrect. Please try again.";
textArray7[iIndex++]="DHCP/BOOTP Server not found";
textArray7[iIndex++]="This SNMP Trap IP Address is incorrect. Please try again.";
