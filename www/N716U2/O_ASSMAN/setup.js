...
Len_text1 = 13;		// CPRINTER.HTM		original: 11, 5
Len_text2 = 14;		// CTCPIP.HTM, Rendezvous
Len_text3 = 9;
...
//htmArray = ['csystem','cprinter','cwlan','ctcpip','cnetware','capple','csnmp','csmb'];
htmArray = ['csystem','cprinter','ctcpip','cnetware','capple','csnmp','csmb'];
