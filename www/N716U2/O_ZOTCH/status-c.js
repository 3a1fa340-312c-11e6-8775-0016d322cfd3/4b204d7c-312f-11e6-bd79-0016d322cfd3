...
//tabArray=['PU211 USB 口打印服务器','状态','设置','其它','重启','系统','打印机','TCP/IP','服务','NetWare','AppleTalk','SNMP','SMB',''];
tabArray=['系统','打印机','TCP/IP','服务','NetWare','AppleTalk','SNMP','SMB',''];
...
//randvoo.htm
textArray3[iIndex++]="Rendezvous 设置";
textArray3[iIndex++]="Rendezvous 设置 :";
