...
function findcook()
{
	...
	if(cook == "1" ){
		typ="visible";
		if(itslanguageRC == 'z')
			document.getElementById("more").value ="ÁôÂÃ";
		else if(itslanguageRC == 'c')
			document.getElementById("more").value ="Òþ²Ø";
		else
		...
		typ="hidden";
		if(itslanguageRC == 'z')
			document.getElementById("more").value ="§ó¦h";
		else if(itslanguageRC == 'c')
			document.getElementById("more").value ="¸ü¶à";
		else
