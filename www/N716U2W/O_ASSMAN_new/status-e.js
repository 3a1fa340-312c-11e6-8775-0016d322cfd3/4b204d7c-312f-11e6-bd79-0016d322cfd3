...
tabArray=['Print Server','Status','Setup','Misc','Restart','System','Printer','Wireless','TCP/IP','NetWare','AppleTalk','SNMP','SMB',''];
//Language : English
...
textArray8[iIndex++]="Operating mode :";
textArray8[iIndex++]="Infrastructure mode";
textArray8[iIndex++]="Ad-Hoc mode";
