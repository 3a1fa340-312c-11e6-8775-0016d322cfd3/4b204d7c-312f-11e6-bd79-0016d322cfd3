...
document.write('<TR>');
document.write('<TD HEIGHT=45 ALIGN=left CLASS=TOPTitle><Script Language="JavaScript">showtab(tabindex++);</script></TD>');
document.write('<TD HEIGHT=45 ALIGN=right><img src=images/logo.gif></TD>');
