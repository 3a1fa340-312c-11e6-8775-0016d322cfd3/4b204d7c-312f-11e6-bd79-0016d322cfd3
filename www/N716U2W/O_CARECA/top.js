...
{
document.write('<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH=582>');
document.write('<TR><TD></TD>');
document.write('<TD HEIGHT=80 ALGIN=CENTER CLASS=TOPTitle><Script Language="JavaScript">showtab(tabindex++);</script></TD>');
