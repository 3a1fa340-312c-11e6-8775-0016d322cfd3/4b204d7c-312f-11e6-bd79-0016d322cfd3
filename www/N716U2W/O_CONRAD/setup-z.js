...
tabArray=['Mini-103MN','狀態','設定','其它','重新啟動','系統','無線','TCP/IP','NetWare','AppleTalk','SNMP','SMB','',''];
...
// Translate                                  only "Save & Restart" is to be translated
textArray11[iIndex++]='<input type="button" value="Connecting" onClick="return SaveSettingCWLAN(';
// Begin don't translate
