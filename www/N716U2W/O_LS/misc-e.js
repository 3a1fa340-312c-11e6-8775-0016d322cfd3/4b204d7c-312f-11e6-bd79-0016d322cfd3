...
//Language : English
tabArray=['<IMG SRC=images/LS_logo.gif>','Status','Setup','Misc','Restart','Factory Default','Firmware Upgrade','Restart'];
//tabArray=['Wireless/Wired Dual-Mode Print Server','Status','Setup','Misc','Restart','Factory Default','Firmware Upgrade','Restart'];
