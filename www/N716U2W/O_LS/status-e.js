...
tabArray=['<IMG SRC=images/LS_logo.gif>','Status','Setup','Misc','Restart','System','Printer','Wireless','TCP/IP','NetWare','AppleTalk','SNMP','SMB',''];
//tabArray=['Wireless/Wired Dual-Mode Print Server','Status','Setup','Misc','Restart','System','Printer','Wireless','TCP/IP','NetWare','AppleTalk','SNMP','SMB',''];
//Language : English
