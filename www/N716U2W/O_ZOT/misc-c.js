...
//tabArray=['<IMG SRC=images/LOGO.gif>','状态','设置','其它','重启','回到默认值','升级固件','重启'];
tabArray=['无线/有线 双模打印服务器','状态','设置','其它','重启','回到默认值','升级固件','重启'];

  //upgrade.htm
  headArray[iIndex++] =
      "<br>此屏幕允许您升级打印服务器的固件。<br>注意: 在您继续之前请确认打印服务器的固件是正确的。如果您不能确认，请与当地供应商联系。";
  iIndex = 0;

  //default.htm
  textArray1[iIndex++] =
      "点击 “<b>回到默认值</b>” 然后点击 “<b>确定</b>” 以回到默认值。 <BR><FONT CLASS=F1 COLOR=#FF3300><B>警告! 打印服务器内配置值将全部被清除。</B></FONT><br><br>";
  ...
  textArray3[iIndex++] =
      "<FONT CLASS=F1 COLOR=#FF3300><B>重新启动打印服务器</B></FONT><br><br>您确定现在要重新启动打印服务器吗 ?<br><br>";
  // Translate                               Only OK is to be translated
  textArray3[iIndex++] =
      '<input type=button value="&nbsp;&nbsp;确定&nbsp;&nbsp;" onClick="window.location=';
  // Begin don't translate
