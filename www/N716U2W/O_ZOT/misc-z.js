...
tabArray=['無線/有線雙介面印表伺服器','狀態','設定','其它','重新啟動','回復出廠值','韌體升級','重新啟動'];
  ...
  //upgrade.htm
  headArray[iIndex++] =
      "<br>本頁可以讓您升級印表伺服器的韌體。<BR><font color=red>附註:</font> 在執行升級之前, 請確定您的韌體是正確的。假如您不知道該用哪種韌體, 請與廠商聯絡以尋求技術上的支援。";
  iIndex = 0;

  //default.htm
  textArray1[iIndex++] =
      "點擊「<b>確定</b>」 以回復出廠的預設值。<BR><FONT CLASS=F1 COLOR=#FF3300><B>請注意! 所有目前的設定值都將被抹除。</B></FONT>";
  ...
  textArray3[iIndex++] =
      "<FONT CLASS=F1 COLOR=#FF3300><B>重新啟動印表伺服器</B></FONT><br><br>你想要重新啟動印表伺服器嗎?<br><br>";
  // Translate                               Only OK is to be translated
  textArray3[iIndex++] =
      '<input type=button value="&nbsp;&nbsp;確定&nbsp;&nbsp;" onClick="window.location=';
  // Begin don't translate
