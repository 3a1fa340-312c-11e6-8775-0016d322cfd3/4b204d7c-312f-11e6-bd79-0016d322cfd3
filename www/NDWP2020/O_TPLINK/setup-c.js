...
tabArray=['<IMG SRC=images/TL-WPS510U-SC.jpg>','状态','设置','其它','重启','系统','无线','TCP/IP','NetWare','AppleTalk','SNMP','SMB','',''];
...
textArray10[iIndex++]="无线区域 :";
textArray10[iIndex++]="频段 :";
textArray10[iIndex++]="(美国:1-11, 欧洲 (ETSI):1-13)";
...
textArray11[iIndex++]="( 输入 8 到 63 个字符 ( ASCII ), 或输入 64 个十六进制数字 ( 0 到 9, A 到 F ) )";
// Translate                                  only "Save & Restart" is to be translated
