...
tabArray=['<IMG SRC=images/TL-WPS510U-SC.jpg>','状态','设置','其它','重启','系统','打印机','无线','TCP/IP','NetWare','AppleTalk','SNMP','SMB',''];
...
textArray8[iIndex++]="用户模式";
textArray8[iIndex++]="无线基地台 AP 模式";
...
textArray8[iIndex++]="频段(信道) :";
textArray8[iIndex++]="无线模式 :";
textArray8[iIndex++]="11B 模式";
textArray8[iIndex++]="11G 模式";
textArray8[iIndex++]="B/G/N 混合模式";
textArray8[iIndex++]="11N 模式";
textArray8[iIndex++]="B/G 混合模式";
textArray8[iIndex++]="传输速率 :";
textArray8[iIndex++]="Rx 信号密度 :";
textArray8[iIndex++]="连结品质 :";
textArray8[iIndex++]="安全类型 :";
textArray8[iIndex++]="共享密钥";
textArray8[iIndex++]="WPA-PSK";
textArray8[iIndex++]="WPA2-PSK";
textArray8[iIndex++]="开放系统";
textArray8[iIndex++]="认证方式 :";
textArray8[iIndex++]="WEP 64 位";
textArray8[iIndex++]="WEP 128 位";
textArray8[iIndex++]="无";
