...
//Language : English
//tabArray=['<IMG SRC=images/LOGO.gif>','Status','Setup','Misc','Restart','System','Wireless','TCP/IP','NetWare','AppleTalk','SNMP','SMB','',''];
tabArray=['Mini-103MN','Status','Setup','Misc','Restart','System','Wireless','TCP/IP','NetWare','AppleTalk','SNMP','SMB','',''];
...
textArray0[iIndex++]="Disable";
textArray0[iIndex++]="Enable";
...
textArray11[iIndex++]="8 to 63 characters ( 0 to 9, A to Z, a to z ), or 64 hexadecimal digits ( 0 to 9, A to F )";
// Translate                                  only "Save & Restart" is to be translated
...
function CheckPwd(szURL)
{
	...
	{
		alert("Administrator's Password and confirmed Password are different !");
		return false;
	}
...
function CheckWPASharedKey(f)
{
	...
	{
		alert("It must be between 8 and 63 ASCII characters (0 to 9, A to Z, a to z).");
		return false;
	}
